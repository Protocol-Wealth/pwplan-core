...
_Last updated: 2026-07-07 (Risk Profile tab on the 33-tool contract). Maintain it._

## Status

Last local gate for the Risk Profile tab slice was green: typecheck clean, lint
clean, format check clean, 271 tests pass, build succeeds, and `git diff
--check` is clean.
**This repo is now
...
contract has **33** tools; the UI exposes **22 tabs** (18 one-tool wire tabs, the
...
- `src/App.tsx` (22-tab bar + ScenarioIO), `src/main.tsx`, `src/index.css`, `index.html` — shell.
